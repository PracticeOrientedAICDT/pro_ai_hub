...
params:
  ...
  overview: "The All-Pairs Shortest Paths (APSP) problem is one of the fundamental\
    ...
    \ usage.\r\nAlthough amortized algorithm with O~(n2) update-time has been known\
    \ for nearly two decades [Demetrescu and Italiano, STOC 2003], the current best\
    \ algorithm for worst-case running time with efficient space usage runs is due\
    \ to [Gutenberg and Wulff-Nilsen, SODA 2020], which improves the space usage of\
    \ the previous algorithm due to [Abraham, Chechik, and Krinninger, SODA 2017]\
